...
Templater.prototype.compile = function()
{
	...
	resultText = resultText.replace(/\{(\/?)(\!?)([A-Za-z0-9{}() :._]+?)}?\}/g, function(all, isClose, isComment, blockParams)
	{
		...
		if(!isClose)
		{
			...
			{
				return "\"; " + currentVariable + " += " + blockParamsSplit.slice(1).join(" ") + "; " + currentVariable + " += \"";
			}
...
Templater.prototype.renderToResponse = function(response)
{
	this.onfinish = function()
	{
